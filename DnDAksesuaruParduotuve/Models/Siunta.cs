...
namespace DnDAksesuaruParduotuve
{
    public class Siunta
    {
        ...
        private const int maxS = 1;
        //M dydžio pakuotė: 1-5 kg
        private const int maxM = 5;
        //L dydžio pakuotė: 5-10 kg
        ...
        private Dictionary<char, int> PakuociuInfo(out double siuntimoKaina)
        {
            ...
            {
                if (likoSupakuoti <= maxS)
                {
                    pakuotes.Add('S', 1);
                    likoSupakuoti = 0;
                }
                else if (likoSupakuoti <= maxM)
                {
                    pakuotes.Add('M', 1);
                    likoSupakuoti = 0;
                }
                else
                {
                    ...
                    if (likoSupakuoti <= maxL) likoSupakuoti = 0;
                    else likoSupakuoti -= maxL;
                }
            }
